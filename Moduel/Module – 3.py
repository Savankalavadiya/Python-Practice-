...
l4=[1,1.1,'savan',101,True,55,False]
l4.append(77)
print(l4)

l4.extend(['Kalavadiya',22])
...
l14=['savan',1,'kalavadiya','vinit',55,44,88,99,100]
...
l18= [(1,2,1.1,True,5,6,),('kalavadiya',5.5,7,3,1.1,False,),(5.5,786,'savan',22)]
print(l18)
var1,var2,var3=l18
print('Var1 -:',var1)
print('Var2 -:',var2)    
